...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int questionLenght = Questionnaire.questions.length;
        ...
        switch(v.getId()){
            case R.id.btn_one:
                if(btn_one.getText() == answer){
                    Toast.makeText(MainActivity.this, "You Are Breathtaking", Toast.LENGTH_SHORT).show();
                    NextQuestion(random.nextInt(questionLenght));
                }else{
                    GameOver();
                }
    ...
    private void NextQuestion(int num){
        tv_questions.setText(question.getQuestion(num));
